...
observatories = pd.read_json(
    '/Users/kjnapier/research/spacerocks/spacerocks/obscodes_extended.json').T
...
observatories['Latitude'] = np.degrees(
    observatories.Latitude.values.astype(float))
...
for idx in range(len(observatories)):
    ...
    elevations[idx] = 6378137 * \
        observatories.geocentric_dist.values[idx] - ellipsoid_edge
...
observatories.to_csv(
    '/Users/kjnapier/research/spacerocks/spacerocks/observatories.csv', index=False)
